...
Repo docs are generated, not hand-written: che renders `*.ontoRepo.tpl` onto the repo. Generated files carry an autogenerated header and are never edited directly. Edit the template, re-render.
