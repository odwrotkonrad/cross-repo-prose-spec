...
### The token resolves from the right backend everywhere (todo)
...
### Sandbox github access carries nothing to steal (todo)

I want github clones and api reads running unauthenticated in the pod, with
`gh api /rate_limit` reporting an anonymous limit,
