...
Runs make targets across unfamiliar repos, remembers a fragment of a name at
best.
...
case-insensitively, each match staying in its own group,
...
no completion error, leaving the line unchanged,
