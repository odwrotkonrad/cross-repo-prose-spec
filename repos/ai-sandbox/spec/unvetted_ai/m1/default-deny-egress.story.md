...
### One component decides what leaves the cluster (todo)
...
### An unlisted destination is unreachable by name or by ip (todo)
...
### A rule grants exactly what it names (todo)
