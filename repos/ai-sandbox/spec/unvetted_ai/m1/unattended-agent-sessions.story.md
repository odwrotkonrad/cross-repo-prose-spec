# Feature: Unattended agent sessions
...
I want every write, install and delete confined to the pod, host unchanged,
so that removing the prompts removes no protection.
