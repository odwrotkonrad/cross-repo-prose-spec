...
version anywhere: an unset ref fails the load by name. prose (`PROSE_REF`) was
...
I want automation's per-consumer regen MR after an upstream release to re-render
