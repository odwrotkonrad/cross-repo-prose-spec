...
beside the other agent prose payloads: `ai-harness/ai-tools-configs` `base` renders it to
...
I want `ai-harness/ai-tools-configs` `base` rendering `conventions/conventions.md` from
