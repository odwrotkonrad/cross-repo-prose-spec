...
### A merged change ships without anyone remembering to tag (todo)
...
### The version follows from the tag list, not from memory (todo)
...
### Only catalog content triggers a release (todo)
...
### A published version is always fetchable and verifiable (todo)
